...
The lesson slides are available on Google Drive here: [10.1 Slides](https://docs.google.com/presentation/d/1Jz-Rj6q6LPTBa9orr40UGgCl_W4Oxphm_YtpTIwgl0c/edit)
...
- [Activity File: Cryptography Concepts and Ciphers](activities/09_Ciphers/unsolved/readme.md)
- [Alphabet Bandit's Message](activities/09_Ciphers/unsolved/message.txt)
- Crumpled up note: `{123456} = {341256}`

### 11. Review Cryptography Concepts and Ciphers Activity 

Solution file is available here: [Ciphers Activity Solution Guide](activities/09_Ciphers/solved/readme.md)
...
- [Activity File: OpenSSL](activities/18_openSSL/unsolved/readme.md) 
...
- [Solution Guide: Open SSL Activity Solution Guide](activities/18_openSSL/solved/readme.md)
