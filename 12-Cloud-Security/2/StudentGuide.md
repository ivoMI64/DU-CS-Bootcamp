...
Our virtual machine is not accessible because our security group firewall is blocking all traffic to it. This is to ensure there is no way anyone can gain access to the VM.
