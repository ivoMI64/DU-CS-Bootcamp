...
- Extract and reassemble the malicious file called `video[4].exe and video[5].exe`. 

- Open the Chromium web browser and navigate to www.virustotal.com. Perform a a file search for `video[4].exe`.
...
We can see three files that were imported onto the victim's machine. Again, this information is crucial to investigative teams during malware analysis and should be included in your report.
